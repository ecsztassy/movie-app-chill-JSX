...
{ img: barista, alt: 'Love Barista', year: '2024', duration: '1j 42m', rating: '13+', description: 'Seorang barista muda berjuang mengejar impiannya membuka kedai kopi sendiri sambil menghadapi kisah cinta yang rumit dengan pelanggan setianya.', cast: 'Adhisty Zara, Bryan Domani', genre: 'Drama, Romansa', director: 'Monty Tiwa', recommendations: [] },
{ img: batman, alt: 'The Batman', year: '2022', duration: '2j 56m', rating: '17+', description: 'Bruce Wayne menghadapi pembunuh berantai misterius bernama Riddler yang mengancam Gotham dengan serangkaian teka-teki mematikan.', cast: 'Robert Pattinson, Zoe Kravitz', genre: 'Action, Crime', director: 'Matt Reeves', recommendations: [] },
{ img: clbk, alt: 'Cinta Lama Belum Kelar', year: '2024', duration: '1j 40m', rating: '13+', description: 'Sepasang mantan kekasih dipertemukan kembali dalam situasi yang memaksa mereka menghadapi perasaan lama yang belum selesai.', cast: 'Jourdy Pranata, Prilly Latuconsina', genre: 'Romansa, Drama', director: 'Ernest Prakasa', recommendations: [] }
]
},
...
{ img: foufo, alt: 'FOUFO', year: '2024', duration: '1j 35m', rating: 'Semua Umur', description: 'Petualangan lucu penuh warna dari karakter unik yang mencoba menyelamatkan dunianya dari ancaman besar.', cast: 'Voice Cast Animation', genre: 'Animasi, Komedi', director: 'Unknown', recommendations: [] },
{ img: marvel, alt: 'Avengers Endgame', year: '2019', duration: '3j 1m', rating: '13+', description: 'Para Avengers yang tersisa melakukan misi terakhir untuk membalikkan kehancuran besar yang disebabkan oleh Thanos.', cast: 'Robert Downey Jr, Chris Evans', genre: 'Action, Sci-Fi', director: 'Russo Brothers', recommendations: [] },
{ img: moana, alt: 'Moana', year: '2016', duration: '1j 47m', rating: 'Semua Umur', description: 'Moana memulai perjalanan berbahaya melintasi samudra untuk menyelamatkan pulau dan rakyatnya.', cast: 'Aulii Cravalho, Dwayne Johnson', genre: 'Animation, Adventure', director: 'Ron Clements', recommendations: [] }
]
},
...
{ img: petaka, alt: 'Petaka Gunung Gede', year: '2024', duration: '1j 46m', rating: '17+', description: 'Pendakian berubah menjadi teror ketika sekelompok anak muda tersesat di gunung yang dipercaya memiliki kutukan lama.', cast: 'Arbani Yasiz, Kiesha Alvaro', genre: 'Horror', director: 'Azhar Kinoi Lubis', recommendations: [] },
{ img: robin, alt: 'Robin Hood', year: '2018', duration: '1j 56m', rating: '13+', description: 'Robin Hood memimpin pemberontakan melawan korupsi kerajaan dan menjadi simbol perjuangan rakyat kecil.', cast: 'Taron Egerton, Jamie Foxx', genre: 'Action, Adventure', director: 'Otto Bathurst', recommendations: [] },
{ img: spiderman, alt: 'Spider-Man No Way Home', year: '2021', duration: '2j 28m', rating: '13+', description: 'Peter Parker menghadapi kekacauan multiverse ketika identitasnya terbongkar ke seluruh dunia.', cast: 'Tom Holland, Zendaya', genre: 'Action, Sci-Fi', director: 'Jon Watts', recommendations: [] }
]
},
...
{ img: superman, alt: 'Superman Legacy', year: '2025', duration: '2j 10m', rating: '13+', description: 'Clark Kent mencoba menyeimbangkan kehidupannya sebagai jurnalis biasa dan pelindung bumi.', cast: 'David Corenswet, Rachel Brosnahan', genre: 'Action, Superhero', director: 'James Gunn', recommendations: [] },
{ img: tanah, alt: 'Tanah Air Beta', year: '2024', duration: '1j 43m', rating: '13+', description: 'Drama keluarga tentang perjuangan bertahan hidup di tengah konflik sosial yang memisahkan orang-orang tercinta.', cast: 'Reza Rahadian, Laura Basuki', genre: 'Drama', director: 'Hanung Bramantyo', recommendations: [] },
{ img: usaha, alt: 'Saat Aku Bersuara', year: '2024', duration: '1j 38m', rating: '13+', description: 'Seorang pemuda membangun bisnis dari nol sambil menghadapi tekanan keluarga dan persaingan keras.', cast: 'Iqbaal Ramadhan, Shenina Cinnamon', genre: 'Drama', director: 'Yandy Laurens', recommendations: [] }
]
}
]
